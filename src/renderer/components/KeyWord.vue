  ...
  <div id="keywords" class="content">
    ...
    <table class="electron-table">
      ...
      <tr v-for="item in list" :key="item.id">
        ...
        <td align="center">{{item.nokeyword}}</td>
...
export default {
  ...
  methods: {
    ...
    doAddKeywords() {
      ...
      // 执行提交数据
      this.$http
        .post(tools.config.apiUrl + "index.php?m=Api&a=addKeywords", {
    ...
    getKeywordsList() {
      ...
      var api =
        tools.config.apiUrl +
        "index.php?m=Api&a=keywordsList&uid=" +
        userinfo.id +
        "&sign=" +
        sign;
    ...
    editKeywords(id) {
      ...
      var api =
        tools.config.apiUrl +
        "index.php?m=Api&a=oneKeywordsList&id=" +
        id +
        "&uid=" +
        userinfo.id +
        "&sign=" +
    ...
    doEditKeywords() {
      ...
      // 执行提交数据
      this.$http
        .post(tools.config.apiUrl + "index.php?m=Api&a=editKeywords", {
          id: this.editForm.id,
    ...
    removeKeywords(id) {
      ...
      this.$http
        .post(tools.config.apiUrl + "index.php?m=Api&a=removeKeywords", {
          id: id,
          uid: userinfo.id,
          sign: sign, //签名
        })
